...
//         h1.textContent = "You have iput something";
//         document.body.prepend(h1);
//         h1.style.color = "red";
//         // console.error("You have iput something");
//     }
...
//     const li = e.target.closest("li"); // target ni najok na li ni values 

//     const index = [...ul.children].indexOf(li);

//     // remove task
//     console.log(e.target);
//     if(e.target.classList.contains("datele")){
