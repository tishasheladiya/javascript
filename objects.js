...
// Spread
let user_data = { ...demo };
let user_data_1 = { gender: "male", role: "user", ...demo }; // add key-value and copy object
...
// ex. website par thi user form ma data add kare che ane te data backend pase object formate ma aave che
// const userProfile = {
//   name: "Rahul",
