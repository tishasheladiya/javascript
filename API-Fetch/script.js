...
// fetch API is used to make network requests and handle responses in JavaScript.
// It provides a modern and flexible way to interact with APIs and retrieve data from servers. 
// The Fetch API is built on top of Promises, which allows for easier handling of asynchronous operations.

// HTTP Basics: HTTP (Hypertext Transfer Protocol) is the foundation of data communication on the web. 
// It defines how messages are formatted and transmitted between clients (like browsers) and servers.
// HTTP uses methods like GET, POST, PUT, DELETE, etc., to perform different actions on resources.
//  Understanding HTTP basics is crucial for working with APIs and making network requests effectively.
                ...
                <div class="absolute inset-0 backface-hidden rotate-y-180 bg-indigo-700 rounded-2xl p-6 text-white flex flex-col">
                    ...
                    <div class="space-y-4 text-xs">
                        <section>
                            ...
                            <p class="text-sm font-mono">${user.username}</p>
                        </section>

                        <section>
                            <label class="block opacity-60 font-bold uppercase tracking-tighter">UID (UIDAI)</label>
                            <p class="text-sm font-mono">5242 4762 5356</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p class="text-sm text-indigo-100">${user.location.timezone.offset} (${user.location.timezone.description})</p>
                        </section>
                    </div>
